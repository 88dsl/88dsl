...
angular.module('ngGrid').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('footerTemplate.html',
    ...
    "\n" +
    "            <select style=\"float: left;height: 27px; width: 100px\" ng-model=\"pagingOptions.pageSize\" ng-init=\"pagingOptions.pageSize=pagingOptions.initPageSize\" >\r" +
    "\n" +

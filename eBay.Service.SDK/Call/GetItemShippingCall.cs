...
namespace eBay.Service.Call
{
	...
	public class GetItemShippingCall : ApiCall
	{
		...
		/// 
		/// <param name="ItemID">
		/// The unique identifier of the listing for which to retrieve estimated shipping costs for all offered shipping service options. The <b>ItemID</b> value passed into this field should be for an listing that offers at least one calculted shipping service option, and for an item that has yet to be shipped.
		/// </param>
		///

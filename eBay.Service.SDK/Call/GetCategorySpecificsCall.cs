...
namespace eBay.Service.Call
{
	...
	public class GetCategorySpecificsCall : ApiCall
	{
		...
		/// A unique identifer for an eBay category. Recommended Item Specifics names and values will be retrieved for each eBay category that is specified. Up to 100 <b>CategoryID</b> values may be specified in one call.
		/// 

...
namespace eBay.Service.Call
{
	...
	public class GetSellerTransactionsCall : ApiCall
	{
		...
		/// If this field is included in the call request and set to <code>true</code>, taxpayer identification information for the buyer is returned under the <b>BuyerTaxIdentifier</b> container in the response.
		/// 
